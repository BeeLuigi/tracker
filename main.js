function Update() {
	...
	if(Game.theme == "dark" && Game.themeChange) {
		if (Person.type == "soli") {
			Game.bomb_bag_img= "./images/bomb.png";
			Game.letter_img= "./images/bottle_letter.png";
			Game.boomerang_img= "./images/boomerang.png";
			Game.hookshot_img= "./images/hookshot.png";
			Game.bow_img= "./images/bow.png";
			Game.goron_bracelet_img= "./images/lift1.png";
			Game.hammer_img= "./images/hammer.png";
			Game.iron_boots_img= "./images/ironboots.png";
			Game.golden_scale_img= "./images/scale2.png";
			Game.longshot_img= "./images/longshot.png";
			Game.silver_gauntlets_img= "./images/lift2.png";
			Game.mirror_shield_img= "./images/shield3.png";
			Game.dins_fire_img= "./images/din.png";
			Game.magic_meter_img= "./images/magic1.png";
			Game.hover_boots_img= "./images/hoverboots.png";
			...
			document.getElementById("gan_req2").src="./images/lightarrow.png";
			document.getElementById("gan_req1").src="./images/magic1.png";
			document.getElementById("gan_req3").src="./images/bow.png";
			document.getElementById("lullabyimg").src="./images/zelda.png";
			document.getElementById("eponasimg").src="./images/epona.png";
			document.getElementById("sariasimg").src="./images/saria.png";
			document.getElementById("sunsimg").src="./images/sunsong.png";
			document.getElementById("sotimg").src="./images/songoftime.png";
			document.getElementById("sosimg").src="./images/songofstorms.png";
			document.getElementById("minuetimg").src="./images/green_note.png";
			document.getElementById("boleroimg").src="./images/red_note.png";
			document.getElementById("serenadeimg").src="./images/blue_note.png";
			document.getElementById("requiemimg").src="./images/orange_note.png";
			document.getElementById("nocturneimg").src="./images/purple_note.png";
			document.getElementById("preludeimg").src="./images/yellow_note.png";
			document.getElementById("faroresimg").src="./images/farore.png";
			document.getElementById("bottleimg").src="./images/bottle.png";
			document.getElementById("firearrowsimg").src="./images/firearrow.png";
			document.getElementById("silverscaleimg").src="./images/scale1.png";
		...
		if(document.getElementById('text_gen_med1') != null) {document.getElementById('text_gen_med1').style.color = 'plum';}
		if(document.getElementById('text_gen_med2') != null) {document.getElementById('text_gen_med2').style.color = 'orange';}
		if(document.getElementById('text_gen_med3') != null) {document.getElementById('text_gen_med3').style.color = 'yellow';}
